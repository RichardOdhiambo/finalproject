...
$sql = "INSERT INTO members_table(member_no,id_number,first_name, surname,last_name,phone_number,address,resident_location,username,password) VALUES('$member_number','$id_number','$f_name' ,'$surname','$l_name','$phone','$address','$resident_location','$username','$password')";
